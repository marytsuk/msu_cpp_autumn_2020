...
int main()
{
	...
	BigInt ob1("000123456789123456789");
	...
	cout << "(6789 - 123456) = -116667) test11 = " << test11 << endl;
	assert(test11.ReturnString() == "-116667");

	BigInt test12 = ob2 -(-ob3);
	cout << "(6789 - (-123456) = 130245) test12 = " << test12 << endl;
	assert(test12.ReturnString() == "130245");

	BigInt test13 = -ob3 - ob2;
	cout << "(-123456 - 6789) = -130245) test13 = " << test13 << endl;
	assert(test13.ReturnString() == "-130245");
	...
	BigInt ob5("99999999999999");
	BigInt ob6("99999999999999");
	BigInt str = ob5 * ob6;
	cout << str << endl;
